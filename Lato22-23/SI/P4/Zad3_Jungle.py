...
class MCTS:
    ...
    def select_node(self):
        ...
        while len(node.children) != 0:
            ...
            min_value = min(children, key=lambda child: child.num_of_visits).num_of_visits
            min_nodes = [n for n in node.children.values()
                         if n.num_of_visits == min_value]
            # print(min_nodes)
    ...
    for i in range(10):
        ...
        while not MCTS_Agent.root_state.isGameOver():
            ...
            if MCTS_Agent.root_state.curplayer: # Duże litery
                ...
                move = MCTS_Agent.root_state.random_move(MCTS_Agent.root_state.curplayer)
                MCTS_Agent.root_state.do_move(move)
